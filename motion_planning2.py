...
from planning_utils2 import a_star, heuristic, create_grid_and_edges, prune_path, find_start_goal
...
class MotionPlanning(Drone):
    ...
    def plan_path(self):
        ...
        print('Building grid and voronoi edges')
        ...
        #plot voronoi to verify. Very slow
        """
        print('Plot voronoi for verification')
        ...
        start_node, goal_node = find_start_goal(graph, grid_start, grid_goal)
        
        # Run A* to find a path from start to goal
        # TODO: add diagonal motions with a cost of sqrt(2) to your A* implementation
        # or move to a different search space such as a graph (not done here)
        print('Local Start and Goal: ', grid_start, grid_goal)
        print('Graph Start and Goal: ', start_node, goal_node)
        print('Start A*')
        path, _ = a_star(graph, heuristic, start_node, goal_node)
